...
function Badge({ text }: { text: string }) {
  return (
    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-[#E2E6D8] bg-white text-[11px] font-semibold text-[#1565C0] whitespace-nowrap shadow-xs">
...
export default function HeroSection({ t }: HeroSectionProps) {
  const { isAuthenticated } = useMerchantStore();
