...
/**
 * Uploads a voice recording to STT transcription service (Web version)
 * @param audioFile Browser File or Blob
...
export const postVoiceEntry = async (
  ...
  formData.append(
    'file',
    audioFile,
    audioFile instanceof File ? audioFile.name : 'note.webm'
  );
