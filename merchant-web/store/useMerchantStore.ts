...
export const useMerchantStore = create<MerchantStore>()(
  persist(
    (set, get) => ({
      ...
      setLang: (lang) => {
        set({ lang });
        safeLocalStorage.setItem('@dhansetu_lang', lang);
      },
      hasChosenLang: false,
      setHasChosenLang: (hasChosenLang) => {
        set({ hasChosenLang });
        safeLocalStorage.setItem('@dhansetu_has_chosen_lang', hasChosenLang ? 'true' : 'false');
      },
      ...
      login: async (phone, token, enterpriseId, proprietorName) => {
        ...
        safeLocalStorage.setItem('@dhansetu_token', token);
      ...
      logout: () => {
        ...
        safeLocalStorage.removeItem('@dhansetu_token');
      },
      ...
      setSmsAutoDetectEnabled: (enabled) => {
        ...
        safeLocalStorage.setItem('@dhansetu_sms_auto_detect', enabled ? 'true' : 'false');
      },
      smsDetectedCount: 0,
      ...
      setSmsHistoricalScanDone: (done) => {
        ...
        safeLocalStorage.setItem('@dhansetu_sms_scan_done', done ? 'true' : 'false');
      },
      ...
      setSmsHistoryImportEnabled: (enabled) => {
        ...
        safeLocalStorage.setItem('@dhansetu_sms_history_import', enabled ? 'true' : 'false');
      },
      hasDedupKey: (key) => {
