...
export const L: Record<SupportedLang, Translations> = {
  en: {
    ...
    disclaimer: 'Unauthorized access to this government system is strictly prohibited under the IT Act 2000.',
    ...
    supportHelpdesk: 'Government Nodal Support',
  ...
  hi: {
    ...
    disclaimer: 'आईटी अधिनियम 2000 के तहत इस सरकारी प्रणाली तक अनधिकृत पहुँच सख्त वर्जित है।',
    ...
    supportHelpdesk: 'सरकारी नोडल सहायता केंद्र',
  ...
  mr: {
    ...
    disclaimer: 'आयटी कायदा २००० अंतर्गत या सरकारी प्रणालीत अनधिकृत प्रवेशास सक्त मनाई आहे.',
    ...
    supportHelpdesk: 'सरकारी नोडल मदत केंद्र',
  ...
  te: {
    ...
    disclaimer: 'IT చట్టం 2000 ప్రకారం ఈ ప్రభుత్వ వ్యవస్థలోకి అనధికారిక ప్రవేశం తీవ్ర నేరం.',
    ...
    supportHelpdesk: 'ప్రభుత్వ నోడల్ సపోర్ట్',
